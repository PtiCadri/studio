...
import { PrestationId, Prestations as Pres } from "@/constants/prestations/prestations";
import { PrestationsDescriptions } from "@/constants/prestations/prestations";
...
export default function Prestations() {
    const [activeCard, setActiveCard] =
        useState<PrestationId | null>(null);
